    ...
    */
    execute: (message, args) => {
        if (args.length > 0) {
            ...
            Data.ExecuteQuery('UPDATE ' + process.env.SQL_NAME + '.channel_data SET guest_mkc_url = "", guest_tag = "' + Data.sql.connection.escape(args[0]) + '" WHERE channel_id = ' + message.channel.id + ';', 
            (error) => {
