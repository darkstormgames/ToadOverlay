    ...
    */
    execute: (message, args) => {
        ...
        if (args.length > 0) {
            ...
            base.db.ExecuteQuery('UPDATE ' + process.env.SQL_NAME + '.channel_data SET guest_mkc_url = "", guest_tag = "' + base.db.sql.connection.escape(args[0]) + '" WHERE channel_id = ' + message.channel.id + ';', 
            (error) => {
