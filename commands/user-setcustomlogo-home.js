 ...
 */
const name = 'setlogo-home';

/**
 * @description Alternative trigger(s) for the command
 */
const alt = ['hsetlogo', 'hlogo', 'logo-home'];
...
function execute(message, args) {
    if (message.attachments.size > 0) {
        ...
        message.channel.send('No valid image given!\nPlease provide an image through an URL to your logo or by uploading it directly to this channel with the command as text.\n' 
                                + '```Example:\n_setlogo-home https://media.discordapp.net/attachments/534321571041378305/805849643548147722/YoshiPink-MK8.png```');
    }
}
