 ...
 */
function getPage(url, guild_id, isHome) {
    return new Promise(function (resolve) {
        ...
        .then((page) => {
            ...
            .then((content) => {
                ...
                if (isHome) {
                    sql_update_string = 'UPDATE ' + base.query.dbName + '.user_data SET home_mkc_link = "' + url + '", home_name = "' + team_name + '", home_tag = "' + team_tag + '", home_img = "' + team_logo + '", last_updated = now() WHERE guild_id = ' + guild_id + ';';
                }
                else {
                    sql_update_string = 'UPDATE ' + base.query.dbName + '.user_data SET guest_mkc_link = "' + url + '", guest_name = "' + team_name + '", guest_tag = "' + team_tag + '", guest_img = "' + team_logo + '", last_updated = now() WHERE guild_id = ' + guild_id + ';';
                }
